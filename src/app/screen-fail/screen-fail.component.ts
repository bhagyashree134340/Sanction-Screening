...
@Component({
  selector: 'app-screen-fail',
  templateUrl: './screen-fail.component.html',
  styleUrls: ['./screen-fail.component.css']
})
export class ScreenFailComponent implements OnInit {
  ...
  ngOnInit(): void {
    this.service.showScreenFailTransactions().subscribe(response=>{this.transactions=response})
  }
...
//http://localhost:8086/checkSanctionList
