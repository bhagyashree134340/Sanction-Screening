...
@Component({
  selector: 'app-validation-fail',
  templateUrl: './validation-fail.component.html',
  styleUrls: ['./validation-fail.component.css']
})
export class ValidationFailComponent implements OnInit {
  ...
  ngOnInit(): void {
    this.service.showValidFailTransactions().subscribe(response=>{this.transactions=response})
  }
