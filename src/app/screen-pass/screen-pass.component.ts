...
@Component({
  selector: 'app-screen-pass',
  templateUrl: './screen-pass.component.html',
  styleUrls: ['./screen-pass.component.css']
})
export class ScreenPassComponent implements OnInit {
  ...
  ngOnInit(): void {
    this.service.showScreenPassTransactions().subscribe(response=>{this.transactions=response})
  }
  exit() {
